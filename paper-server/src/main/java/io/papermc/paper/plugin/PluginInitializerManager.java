...
public class PluginInitializerManager {
    ...
    public static void reload(DedicatedServer dedicatedServer) {
        ...
        if (hasPaperPlugin) {
            LOGGER.warn("======== PERIGO ========");
            LOGGER.warn("Você está recarregando enquanto há plugins Paper instalados no seu servidor.");
            LOGGER.warn("Plugins Paper NÃO suportam ser recarregados. Isso causará alguns problemas inesperados.");
            LOGGER.warn("=========================");
        }
    }
}
